...
import EditWastageCone from '../weftwastage/EditWastageCone';

const WeftReturnList = React.memo(({ getItemDescription, qrData, errors, checkInput, ProductionLocation, navigateToCamera }) => {
  ...
  const tableHead = ['','LotNo', 'StockCone', 'ConeWeight', 'StockQty', 'WastageCone', 'WastageQty'];
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Weft Wastage List</Text>
                  ...
                  data={[
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                      ...
                      <TouchableOpacity style={{ marginLeft: 10 }}>
                        <EditWastageCone StockCone={rowData.StockCone} StockID={rowData.StockID}
